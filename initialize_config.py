...
def initialize_config(config):
    ...
    set_default_value(config, "template_fragment_object_pointcloud",
                      "fragments/fragment_%03d/object_%02d_%02d.ply")
    ...
    set_default_value(config, "object_size_threshold", 1000)
    set_default_value(config, "obj_confidence_threshold", 0.7)
